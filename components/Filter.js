...
const Filter = ({ setFilter, setActiveToggle }) => {
     ...
     const handleCoronaToggle = () => {
          isCorona = !isCorona;
          Router.router.push({
               pathname: '/',
               query: { ...Router.router.query, corona: isCorona },
          });
     };
     ...
     useEffect(() => {
          ...
          return () => {
               mainArea.current.removeEventListener(
                    'change',
